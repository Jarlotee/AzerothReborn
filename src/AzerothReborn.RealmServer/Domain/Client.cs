...
public class Client
{
    private readonly PacketEncryptionState _packetEncryption = new PacketEncryptionState();
    ...
    public Reference.AccessLevel Access { get; set; } = Reference.AccessLevel.Player;
    public Reference.ExpansionLevel Expansion { get; set; } = Reference.ExpansionLevel.Classic;
    ...
    {
        if (!_packetEncryption.IsEncryptionEnabled)
        {
            return;
        }

        var key = _packetEncryption.Key;
        var hash = _packetEncryption.Hash ?? throw new ApplicationException("Hash is null");
        for (var i = 0; i < 6; i++)
        {
            var tmp = data[i];
    ...
    public Task OnConnectAsync()
    {
        ...
        // {
        //     throw new ApplicationException("Socket does not have a RemoteEndPoint");
        // }
    ...
    public void OnPacket(Network.PacketClass p)
    {
        throw new NotImplementedException();
        // if (Socket is null)
        // {
    ...
    public void Send(Network.PacketClass packet)
    {
        throw new NotImplementedException();
        // if (packet == null)
        // {
    ...
    public void SendMultiplyPackets(Network.PacketClass packet)
    {
        throw new NotImplementedException();
        // if (packet is null)
        // {
