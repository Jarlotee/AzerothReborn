...
CREATE TABLE `game_event` (
  ...
  `start_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Global starting date for the event.',
  `end_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Global ending date of the event.',
